...
For K = 2,...,6 breakpoints, we run model on entire data.
...
Optimal number of breakpoints is 3 break points!
...
```
!!!! the 80+ group only works for 2 break points (cp_max_onset = 2, cp_max_backpro = 2)
...
# data_mty <- data_mty[ , !(names(data_mty) %in% c('state'))]
# data_mty
# 
